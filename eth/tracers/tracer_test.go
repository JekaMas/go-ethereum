...
func runTrace(tracer *Tracer) (json.RawMessage, error) {
	env := vm.NewEVM(vm.Context{ContextWithForkFlags: params.NewContextWithBlock(params.TestChainConfig, big.NewInt(1))}, &dummyStatedb{}, vm.Config{Debug: true, Tracer: tracer})
