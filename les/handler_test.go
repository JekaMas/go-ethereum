...
func TestTransactionStatusLes2(t *testing.T) {
	...
	config.Journal = ""
	ctx := params.NewContextWithBlock(params.TestChainConfig, chain.CurrentBlock().Number())
	txpool := core.NewTxPool(ctx, config, types.NewEIP155Signer(params.TestChainConfig.ChainID), chain)
