...
func setupTxPool() (*TxPool, *ecdsa.PrivateKey) {
	...
	pool := NewTxPool(testTxPoolConfig, types.NewEIP155Signer(params.TestChainConfig.ChainID), blockchain)
...
func testTransactionQueueGlobalLimiting(t *testing.T, nolocals bool) {
	...
	pool := NewTxPool(config, types.NewEIP155Signer(params.TestChainConfig.ChainID), blockchain)
	defer pool.Stop()
